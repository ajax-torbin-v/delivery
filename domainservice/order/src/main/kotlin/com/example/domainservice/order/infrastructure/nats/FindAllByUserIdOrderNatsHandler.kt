...
import com.example.domainservice.order.infrastructure.nats.mapper.OrderProtoMapper.toFailureFindOrdersByUserIdResponse
import com.example.domainservice.order.infrastructure.nats.mapper.OrderProtoMapper.toFindOrdersByUserIdResponse
...
internal class FindAllByUserIdOrderNatsHandler(
    ...
    override fun doHandle(inMsg: FindOrdersByUserIdRequest): Mono<FindOrdersByUserIdResponse> {
        return orderInputPort.getAllByUserId(inMsg.id)
            .collectList()
