...
class OrderNatsControllerUnitTest {
    ...
    @InjectMockKs
    private lateinit var findByIdFullOrderNatsHandler: FindByIdFullOrderNatsHandler
    ...
    fun `findById doOnUnexpectedError should return empty error message`() {
        ...
        // WHEN
        val actual = findByIdFullOrderNatsHandler.doOnUnexpectedError(null, exception)
