package com.example.domainservice.order.arch
...
internal class OrderModuleOnionArchitectureTest {
    @Test
    ...
    companion object {
        private val importedClasses: JavaClasses = ClassFileImporter()
            ...
            .importPackages("com.example.domainservice.order")
        ...
        private const val KAFKA_ADAPTER = "..infrastructure.kafka.."
    }
}
